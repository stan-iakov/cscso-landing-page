  ...
  features: [
    {
      ...
      text:
        'Get your invoices funding by a major financial service provider.',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      title: 'Security',
      text:
        'Your invoices will never be lost and will always be processed in the expected timeframe',
    },
  ],
};
